...
-->
  <footer class="bg-gray-800" aria-labelledby="footerHeading">
    ...
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:py-12 lg:px-8">
      <div v-if="false" class="pb-8 xl:grid xl:grid-cols-5 xl:gap-8">
      ...
      <div class="lg:flex lg:items-center lg:justify-between xl:mt-0">
        ...
        >
          ...
          <div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
            <button
              type="submit"
              class="w-full bg-blue-500 border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-base font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-arapawa-500"
            >
              Subscribe
            </button>
          </div>
      ...
      >
        <div v-if="false" class="flex space-x-6 md:order-2">
        ...
        <p class="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
          &copy; 2021 Micro-Saas Collective All rights reserved.
        </p>
      </div>
    </div>
  </footer>
...
export default {
  ...
  methods: {
    async handleSubscribe() {
      try {
        await this.$axios.$post('/api/v1/newsletter_subscriptions.json', {
          subscriber: this.form,
        })
